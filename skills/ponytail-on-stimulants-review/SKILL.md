...
description: >
  Review a diff for both unjustified complexity and unfinished execution:
  stale callers, skipped verification, generated drift, TODOs, avoidable dependencies,
  and speculative abstractions. Use for /ponytail-on-stimulants-review or when the
  user asks whether a change is minimal and actually complete.
---
