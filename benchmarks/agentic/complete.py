...
ponytail-on-stimulants: reuses judge.py's HTTP/key/source plumbing instead of duplicating it -- one rubric
...
ARMS_ORDER = ["baseline", "caveman", "ponytail-on-stimulants", "yagni", "yagni-oneliner"]
