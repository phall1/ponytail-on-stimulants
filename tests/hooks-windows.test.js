...
test('ponytail-on-stimulants-mode-tracker self-exits when stdin never closes (no freeze)', async () => {
  const hook = path.join(root, 'hooks', 'ponytail-on-stimulants-mode-tracker.js');
