...
test('csv: timeout can be raised for slow pandas startup', () => {
  const previous = process.env.PONYTAIL_ON_STIMULANTS_CORRECTNESS_TIMEOUT_MS;
  try {
    process.env.PONYTAIL_ON_STIMULANTS_CORRECTNESS_TIMEOUT_MS = '1';
...
print(351)`,
    ...
    process.env.PONYTAIL_ON_STIMULANTS_CORRECTNESS_TIMEOUT_MS = '1000';
...
print(351)`,
    ...
    if (previous === undefined) delete process.env.PONYTAIL_ON_STIMULANTS_CORRECTNESS_TIMEOUT_MS;
    else process.env.PONYTAIL_ON_STIMULANTS_CORRECTNESS_TIMEOUT_MS = previous;
  }
});
